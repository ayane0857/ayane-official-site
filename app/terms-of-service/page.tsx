      ...
      <main className="px-5 py-10">
        <div className="mx-auto max-w-5xl rounded-lg bg-[#f9f6f7] border-2 p-10 min-h-[600px]">
          ...
          <div className="text-black pl-8">
            <p>
              この利用規約（以下、「本規約」といいます。）は、Ayane Tech
              Lab（以下、「弊団体」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。本サービスを利用する者（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
            </p>
            ...
            <p className="text-xl">第 4 条（禁止事項）</p>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>弊団体のサービスの運営を妨害するおそれのある行為</li>
            ...
            <p className="text-xl">第 5 条（本サービスの提供の停止等）</p>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>弊団体からの連絡に対し、一定期間返答がない場合</li>
              <li>本サービスについて、最終の利用から一定期間利用がない場合</li>
              <li>弊団体が本サービスの利用を適当でないと判断した場合</li>
            </ul>
            <p>
              弊団体は、本条に基づき弊団体が行った行為によりユーザーに生じた損害について、一切の責任を負いません。
            </p>

            <p className="text-xl">第 7 条（退会）</p>
            <p>
              ユーザーは、弊団体の定める退会手続により、本サービスから退会できるものとします。
            </p>

            <p className="text-xl">第 8 条（保証の否認および免責事項）</p>
            <p>
            ...
            <p className="text-xl">第 11 条（個人情報の取扱い）</p>
            <p>
              弊団体は、本サービスの利用によって取得する個人情報については、弊団体「プライバシーポリシー」に従い適切に取り扱うものとします。
            </p>

            <p className="text-xl">第 12 条（通知または連絡）</p>
            <p>
            ...
            <p className="text-xl">第 13 条（準拠法・裁判管轄）</p>
            <p>
            ...
            <p className="text-xl">第 14 条（分離条項）</p>
            <p>
